<x-base>
    <div class="hero bg-base-200 min-h-screen mt-[-5vh] py-10">
    <div class="hero-content flex-col lg:flex-row-reverse gap-[10vw] items-center">
        ...
        <div class="card-body">
            <form action="{{ route('register') }}" method="POST" class="fieldset gapy-[1vw]">
                @csrf
            ...
            <div class="mt-3">
                Already have an account? <span class="text-blue-600/70"><a href="{{ route('login') }}">Log-in</a></span>
            </div>
